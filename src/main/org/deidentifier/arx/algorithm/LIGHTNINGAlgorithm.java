...
public class LIGHTNINGAlgorithm extends AbstractAlgorithm {
	 ...
	 * @return
	 */
	public static AbstractAlgorithm create(SolutionSpace solutionSpace, TransformationChecker checker, int timeLimit,
			int checkLimit) {
	...
	/**
	 * Performs a depth first search (without backtracking) starting from the
	...
	/**
	 * Returns the successor with minimal information loss, if any, null
	 * otherwise.
	 * 
	 * @param queue
	 * @param transformation
	...
	private boolean mustStop() {
		return ((int) (System.currentTimeMillis() - timeStart) > timeLimit) || (checkCount >= checkLimit);
	}
